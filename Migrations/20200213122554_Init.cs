        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolesDescription = table.Column<string>(nullable: true),
                    ResultDescription = table.Column<string>(nullable: true),
                    CustomerOrganization = table.Column<string>(nullable: true),
                    CustomerContacts = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
